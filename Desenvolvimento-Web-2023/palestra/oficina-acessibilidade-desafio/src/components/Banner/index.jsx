      ...
      <Row className="bg-dark">
        <Col className="linear-background">
          <Container className="conteudo-banner mt-5">
            <Row className="mb-5">
              <Col alt="Imagem da Catedral São Pedro de Alcantara com o rio e as árvores ao lado" lg={6} className="p-4">
                <p tabIndex={0} alt="Melhores passeios gastronomicos e pontos turísticos da serra" id="titulo-banner">
                ...
                <Row>
                  <Col className="container-pessoas d-flex flex-direction-row gap-1 mt-3">
                    <img src={perfil1} alt="Fotos de perfil rede social" />
                    <img src={perfil2} alt="Fotos de perfil rede social" />
                    <img src={perfil3} alt="Fotos de perfil rede social" />
                    <img src={perfil4} alt="Fotos de perfil rede social" />
                    <img src={perfil5} alt="Fotos de perfil rede social" />
                  </Col>
                  <Col className="container-avaliacao d-flex flex-direction-row justify-content-between aling-items-center flex-wrap">
                    <img src={estrelaVerde} alt="Estrela verde" />
                    ...
                    <div className="d-flex flex-direction-row align-items-center gap-1">
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Estrela branca dentro de um quadrado verde" />
                      </div>
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Estrela branca dentro de um quadrado verde" />
                      </div>
                      ...
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Uma estrela branca dentro de um quadrado verde" />
                      </div>
                      <div className="background-estrela">
                        <img src={estrelaBranca} alt="Uma estrela branca dentro de um quadrado verde" />
                      </div>
